...
/// @details Attempts to initiate an I2C transmission to the PCF8574 address.
///          If the transmission completes without error, the device is considered connected.
/// @return true, if the device responds to I2C communication (endTransmission returns 0),
///         false otherwise

...
// 读取相对时间的编码器的10ms的数据  Read the data of the encoder of relative time for 10ms
// 此函数可以结合control_pwm的数据，来实现control_speed的功能，需要增加pid控制  This function can be combined with the data of control_pwm to realize the function of control_speed, pid control required.
